...
def main_menu():
    while True:
        ...
        START_TEXT = START_TEXT.render("Start Game", True, "white")
        START_TEXT_RECT = START_TEXT.get_rect()
        START_TEXT_RECT.center = (width/2, 425)
...
def shop():
    ...
    while True:
        ...
        BUY_ELF_TEXT_RECT.center = (300, 215)
        ...
        ELF_PRICE_TEXT_RECT.center = (300, 198)
        ...
        SANTA_TEXT_RECT.center = (300, 265)
        ...
        BUT_SANTA_TEXT_RECT.center = (300, 315)
        ...
        SANTA_PRICE_TEXT_RECT.center = (300, 298)
        ...
        REINDEER_TEXT_RECT.center = (300, 365)
        ...
        BUY_REINDEER_TEXT_RECT.center = (300, 415)
        ...
        REINDEER_PRICE_TEXT_RECT.center = (300, 398)
        ...
        SLEIGH_TEXT_RECT.center = (300, 465)
        ...
        BUY_SLEIGH_TEXT_RECT.center = (300, 515)
        ...
        SLEIGH_PRICE_TEXT_RECT.center = (300, 498)
        ...
        WORKSHOP_TEXT_RECT.center = (625, 165)
        ...
        BUY_WORKSHOP_TEXT_RECT.center = (625, 215)
        ...
        WORKSHOP_PRICE_TEXT_RECT.center = (625, 198)
        ...
        FACTORY_TEXT_RECT.center = (625, 265)
        ...
        BUY_FACTORY_TEXT_RECT.center = (625, 315)
        ...
        FACTORY_PRICE_TEXT_RECT.center = (625, 298)
        SCREEN.blit(FACTORY_PRICE_TEXT, FACTORY_PRICE_TEXT_RECT)

        LAB_TEXT = pygame.font.Font("freesansbold.ttf", 40)
        LAB_TEXT = LAB_TEXT.render(f"Lab: {str(game.get_labs())}", True, "white")
        LAB_TEXT_RECT = LAB_TEXT.get_rect()
        LAB_TEXT_RECT.center = (625, 365)
        SCREEN.blit(LAB_TEXT, LAB_TEXT_RECT)
        BUY_LAB_TEXT = pygame.font.Font("freesansbold.ttf", 15)
        BUY_LAB_TEXT = BUY_LAB_TEXT.render(f"Buy Lab", True, "white")
        BUY_LAB_TEXT_RECT = BUY_LAB_TEXT.get_rect()
        BUY_LAB_TEXT_RECT.center = (625, 415)
        SCREEN.blit(BUY_LAB_TEXT, BUY_LAB_TEXT_RECT)
        LAB_PRICE_TEXT = pygame.font.Font("freesansbold.ttf", 15)
        LAB_PRICE_TEXT = LAB_PRICE_TEXT.render(f"({str(int(10000000 * (game.get_labs()/2 + 1)))})", True, "grey")
        LAB_PRICE_TEXT_RECT = LAB_PRICE_TEXT.get_rect()
        LAB_PRICE_TEXT_RECT.center = (625, 398)
        SCREEN.blit(LAB_PRICE_TEXT, LAB_PRICE_TEXT_RECT)

        PRESENTS_TEXT = pygame.font.Font("freesansbold.ttf", 40)
        PRESENTS_TEXT = PRESENTS_TEXT.render(f"Presents: {str(int(game.get_presents()))}", True, "white")
        PRESENTS_TEXT_RECT = PRESENTS_TEXT.get_rect()
        PRESENTS_TEXT_RECT.center = (950, 275)
        SCREEN.blit(PRESENTS_TEXT, PRESENTS_TEXT_RECT)
        ...
        SAVE_CHRISTMAS_TEXT_RECT.center = (625, 465)
        ...
        BUY_SAVE_CHRISTMAS_TEXT_RECT.center = (625, 515)
        ...
        SAVE_CHRISTMAS_PRICE_TEXT_RECT.center = (625, 498)
        ...
        CLICKUPGRADE_TEXT_RECT.center = (950, 375)
        ...
        BUY_CLICKUPGRADE_TEXT_RECT.center = (950, 425)
        SCREEN.blit(BUY_CLICKUPGRADE_TEXT, BUY_CLICKUPGRADE_TEXT_RECT)
        CLICKUPGRADE_PRICE_TEXT = pygame.font.Font("freesansbold.ttf", 15)
        CLICKUPGRADE_PRICE_TEXT = CLICKUPGRADE_PRICE_TEXT.render(f"({str(int(100 * (game.get_clickUpgrades()/2 + 1)))})", True, "grey")
        CLICKUPGRADE_PRICE_TEXT_RECT = CLICKUPGRADE_PRICE_TEXT.get_rect()
        CLICKUPGRADE_PRICE_TEXT_RECT.center = (950, 408)
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if BUY_FACTORY_TEXT_RECT.collidepoint(pygame.mouse.get_pos()):
                    ...
                    if x >= 1000000:
                        game.buy_factory()
                if BUY_LAB_TEXT_RECT.collidepoint(pygame.mouse.get_pos()):
                    x = game.get_presents()
                    if x >= 10000000:
                        game.buy_lab()
                    else:
